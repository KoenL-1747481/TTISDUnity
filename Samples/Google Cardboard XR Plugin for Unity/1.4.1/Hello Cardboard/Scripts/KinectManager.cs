...
//	public bool NearMode = false;
	...
	public RawImage HandCursor1;
	
	// GUI Texture to display the hand cursor for Player1
	public RawImage HandCursor2;
					...
					else if(gestureData.progress >= 0.1f)
					{
							...
							gestureData.progress >= 0.5f)
						{
							if(GetGestureProgress(gestureData.userId, KinectGestures.Gestures.Click) < 0.3f)
							{
								...
								if(ControlMouseCursor)
								{
									Vector3 vCursorPos = HandCursor1.texture != null ? HandCursor1.transform.position :
							...
							gestureData.progress >= 0.5f)
						{
							if(GetGestureProgress(gestureData.userId, KinectGestures.Gestures.Click) < 0.3f)
							{
								if(HandCursor2 != null)
								{
									...
									/*if(HandCursor2.text == null) dit bolt niet
									{
								...
								if(ControlMouseCursor)
								{
									Vector3 vCursorPos = HandCursor2.texture != null ? HandCursor2.transform.position :
